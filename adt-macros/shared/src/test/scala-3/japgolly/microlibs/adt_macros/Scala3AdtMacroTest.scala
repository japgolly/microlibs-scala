...
object Scala3AdtMacroTest extends TestSuite {
...
//      's3i - assertOrderedNEV(MonoS3.ValuesM)(MonoS3.A, MonoS3.B, MonoS3.C)
      ...
      "dupTypes" - {
        "ok" - assertOrderedNEV(adtValuesManually[MonoD2](allowDuplicateTypes = true)(MonoD2.A, MonoD2.B(true), MonoD2.B(false)))(MonoD2.A, MonoD2.B(true), MonoD2.B(false))
        "ko" - assertFail(compileError("adtValuesManually[MonoD2]()(MonoD2.A, MonoD2.B(true), MonoD2.B(false))"))
      }
      "dupValues" - {
        "ok" - assertOrderedNEV(adtValuesManually[MonoS3](allowDuplicateValues = true)(MonoS3.A, MonoS3.B, MonoS3.C, MonoS3.B))(MonoS3.A, MonoS3.B, MonoS3.C, MonoS3.B)
        ...
        "dupD2" - assertFail(compileError("adtValuesManually[MonoD2](allowDuplicateTypes = true)(MonoD2.B(true), MonoD2.A, MonoD2.B(true), MonoD2.B(false))"))
      }
      "incomplete" - {
